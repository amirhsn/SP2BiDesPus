...
class LaporanPtm extends StatefulWidget{
  @override
  _LaporanPtmState createState() => _LaporanPtmState();

}

class _LaporanPtmState extends State<LaporanPtm>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Laporan Penyakit Tidak Menular"),
        centerTitle: true,
        elevation: 0,
      ),
      body: Container(
